...
public:
     ...
     * with new size. If new and old sizes are equal it does nothing. \param size: elemens number
     * */
     ...
     * is enough. \param host_ptr_arg: pointer to buffer to upload \param size: elemens number
     * */
    ...
    /** \brief Uploads data to internal buffer in GPU memory. It calls create() inside to ensure that intenal buffer size
     * is enough. \param data: host vector to upload from
     * */
    template <class A>
...
public:
    ...
    /** \brief Allocates internal buffer in GPU memory. If internal buffer was created before the function recreates it
     * with new size. If new and old sizes are equal it does nothing. \param rows: number of rows to allocate \param cols:
    ...
    /** \brief Uploads data to internal buffer in GPU memory. It calls create() inside to ensure that intenal buffer size
     * is enough. \param host_ptr: pointer to host buffer to upload \param host_step: stride between two consecutive rows
     * in bytes for host buffer \param rows: number of rows to upload \param cols: number of elements in each row
     * */
    ...
    /** \brief Uploads data to internal buffer in GPU memory. It calls create() inside to ensure that intenal buffer size
     * is enough. \param data: host vector to upload from \param cols: stride in elements between two consecutive rows for
     * host buffer
     * */
    template <class A>
